...
func InitRoutes(service service.AuthService, postService service.PostService, bookService service.BookService, adminService service.AdminService) *gin.Engine {
	router := gin.Default()
